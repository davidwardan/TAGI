...
def forward_input(mu_w1, sigma_w1, mu_b1, sigma_b1, x_train):
    ...
    return mu_z, var_z, cov_z_w, cov_z_b
...
def activation(mu_z, var_z, cov_z_w, cov_z_b):
    ...
    return mu_a, var_a, cov_a_w, cov_a_b, J
...
def update_hidden(J, var_z, var_z0, mu_z, mu_z0, mu_z0_inf, var_z0_inf, mu_w2):
    ...
    return mu_post_z, var_post_z

def update_parameters(var_z0, cov_z0_w, cov_z0_b, mu_w2, mu_z0_post, mu_z0, sigma_w2, var_z0_post, mu_b2, sigma_b2, cov_z_w, cov_z_b, var_z, mu_w1, mu_post_z, mu_z, var_post_z):
    ...
    return mu_post_w2, var_post_w2, mu_post_b2, var_post_b2, mu_post_w1, var_post_w1, mu_post_b1, var_post_b1